...
| 来路 | 含义 | 现有 |
| --- | --- | --- |
| `extracted` | 自原书文本逐条提取、清洗、标注条目位置 | 4（《穷通宝鉴》120 格、《滴天髓》4 篇、《子平真詮》8 格、《神峰通考》1 篇） |
...
| 书 | 受阻之处 |
| --- | --- |
| 三命通會 | 维基文库本仅录九卷（原书十二卷），九卷全扫未见天乙贵人起例口诀 |
| 淵海子平 | 该本页首自注「此文档未完成」，七十三篇中无文昌一节 |
| 協紀辨方書 | 维基文库无此书。先前 catalog 里那条 ref 是死链，已清空 |

三者的起例规则仍在用（`derived`，自算法常量导出，注释里录着口诀），只是未能回原书
复核，故不升为 `extracted`。
